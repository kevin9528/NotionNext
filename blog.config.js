...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cccweb3.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小龙btc, 博客，Web3，比特币，以太坊', // 网站关键词 英文逗号隔开
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || '428bb2c6d63ee5ff2b2006e84305d51e', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'o00yhzttrr', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '小龙btc', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
